...
<head>
    ...
    <meta name="description" content="Frontend Developer position at TechNova. Join our team to build modern web interfaces with React and modern technologies.">
</head>
<body>
            ...
            <div class="container">
                <div class="job-header-content">
                    <div class="company-info">
                        <img src="/ProfilePhotos/{{ $job->profile_photo }}" alt="TechNova Logo" class="company-logo-large">
                    ...
                    <div class="apply-section">
                        <a href="{{ route('applyJob',['c_id' => $job->company_id, 'j_id' => $job->id,'company_name'=>$job->company_name,'job_title'=>$job->jobtitle,'city'=>$job->city,'state'=>$job->state]) }}" class="btn btn-primary btn-large">Apply Now</a>
                        <a href="{{ route('jobListings') }}" class="btn btn-outline">Back to Jobs</a>
                    </div>
                </div>
            </div>
        </section>
